...
export default function AddStockSheet({ branchName, onSubmit, onClose }: Props) {
    ...
    return (
        <View style={s.container}>
            <View style={s.header}>
                <Text style={[s.title, { color: C.text[scheme] }]}>Add Stock</Text>
            ...
            <View style={s.body}>
                <Text style={[s.label, { color: C.text[scheme] }]}>Branch</Text>
                <View style={[s.readOnly, { backgroundColor: C.inputBg[scheme] }]}>
                    <Text style={[s.readOnlyText, { color: C.secondary[scheme] }]}>{branchName}</Text>
                </View>
                ...
                <TouchableOpacity
                    ...
                    disabled={loading}
                >
                    {loading ? <ActivityIndicator color="#fff" /> : <Text style={s.submitText}>Add Stock</Text>}
                </TouchableOpacity>
            </View>
